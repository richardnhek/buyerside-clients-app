...
final parametersBuilderMap =
  ...
  'refer': ParameterData.none(),
  'MembersDetail': (data) async => ParameterData(
        allParams: {
          'chatRef': getParameter<DocumentReference>(data, 'chatRef'),
        },
      ),
  ...
  'AddUserToChat': (data) async => ParameterData(
        allParams: {
          'chatRef': getParameter<DocumentReference>(data, 'chatRef'),
        },
      ),
  'UserDetail': (data) async => ParameterData(
        allParams: {
          'userDoc': await getDocumentParameter<UsersRecord>(
              data, 'userDoc', UsersRecord.fromSnapshot),
        },
      ),
  'AllServices': ParameterData.none(),
  'OrderInspection': ParameterData.none(),
  'Profile': (data) async => ParameterData(
        allParams: {
          'userProfilePic': getParameter<String>(data, 'userProfilePic'),
          'userDoc': await getDocumentParameter<UsersRecord>(
              data, 'userDoc', UsersRecord.fromSnapshot),
        },
      ),
