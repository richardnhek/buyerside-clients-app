      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'refer') : const ReferWidget(),
        ),
        FFRoute(
          name: 'MembersDetail',
          path: '/membersDetail',
          builder: (context, params) => MembersDetailWidget(
            chatRef: params.getParam(
                'chatRef', ParamType.DocumentReference, false, ['chats']),
          ),
        ),
        ...
        FFRoute(
          name: 'AddUserToChat',
          path: '/addUserToChat',
          builder: (context, params) => AddUserToChatWidget(
            chatRef: params.getParam(
                'chatRef', ParamType.DocumentReference, false, ['chats']),
          ),
        ),
        ...
        FFRoute(
          ...
          path: '/allServices',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'AllServices')
              : const AllServicesWidget(),
        ),
        FFRoute(
          name: 'OrderInspection',
          path: '/orderInspection',
          builder: (context, params) => const OrderInspectionWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'BuyerAgent',
          path: '/buyerAgent',
          builder: (context, params) => const BuyerAgentWidget(),
        ),
        FFRoute(
          name: 'WebViewPage',
          path: '/webViewPage',
          builder: (context, params) => WebViewPageWidget(
            iframeUrl: params.getParam('iframeUrl', ParamType.String),
          ),
        )
